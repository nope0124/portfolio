      ...
      <div className="container mx-auto flex flex-col items-center w-11/12">
        ...
        <div className="mt-8 relative w-9/12">
          ...
          <ul className="list-none m-0 p-0">
            <Item date="2023/09 ~ 2023/10" title="RECRUIT Internship for Engineers, Data Specialists 2023"/>
            <Item date="2023/08" title="GREE Camp 2023" />
            ...
            <Item date="2021/07 ~ 2022/12" title="株式会社インフラトップ 長期インターン" />
